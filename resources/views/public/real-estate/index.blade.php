<x-layouts.public title="Real Estate - Babilas Investment Group">
    ...
    <section class="bg-hero-gradient py-20">
        <div class="max-w-screen-2xl mx-auto px-6 lg:px-10 2xl:px-16 text-center">
            ...
            <h1 class="text-4xl lg:text-5xl font-bold text-white mb-4">Real Estate</h1>
            <p class="text-slate-300 text-lg max-w-2xl mx-auto">Premium properties and developments across Nigeria's most prestigious locations.</p>
        </div>
    </section>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-screen-2xl mx-auto px-6 lg:px-10 2xl:px-16">
            @if ($properties->isEmpty())
                <p class="text-center text-slate-500 py-20">No properties available at the moment.</p>
            @else
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
                    @foreach ($properties as $property)
                    <a href="{{ url('/real-estate/' . $property->slug) }}" class="investment-card group flex flex-col">
                        ...
                        <div class="flex-1 p-5">
                            <h3 class="text-big-navy-dark font-bold text-lg mb-2 group-hover:text-big-gold-dark transition-colors">{{ $property->name }}</h3>
