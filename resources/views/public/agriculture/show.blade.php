<x-layouts.public :title="$project->name . ' - Babilas Investment Group'">
    ...
    <section class="py-10 bg-white">
        <div class="max-w-screen-2xl mx-auto px-6 lg:px-10 2xl:px-16">
            <a href="{{ url('/agriculture') }}" class="text-sm text-slate-500 hover:text-big-navy-dark inline-flex items-center gap-1 mb-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-10">
                <div class="lg:col-span-2">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <span class="text-slate-400 text-sm">{{ $project->agriculture_type }}</span>
                    </div>
                    <h1 class="text-3xl lg:text-4xl font-bold text-big-navy-dark mb-3">{{ $project->name }}</h1>
                    <div class="flex items-center gap-1.5 mb-8">
                        <i data-lucide="map-pin" class="w-4 h-4 text-slate-400"></i>
                        <span class="text-slate-500">{{ $project->location }}</span>
                    </div>
                ...
                <div>
                    <div class="bg-slate-50 rounded-2xl p-6 sticky top-24">
                        <p class="text-slate-400 text-xs uppercase tracking-wide mb-1">Interested in this project?</p>
                        <p class="text-slate-600 text-sm mb-6">Reach out to our investment team to learn more about partnership opportunities.</p>
